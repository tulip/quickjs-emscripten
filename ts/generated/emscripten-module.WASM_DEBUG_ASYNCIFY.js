...
Module['onAbort'] = function (what) {
  throw new Module['AbortError'](what);
};
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 5242880;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 5242880, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 5242880);
      ...
      while (callbacks.length > 0) {
        ...
        if (typeof func == 'number') {
          if (callback.arg === undefined) {
            ...
            (function() { throw 'Internal Error! Attempted to invoke wasm function pointer with signature "v", but no such functions have gotten exported!'; })();
          } else {
            // If any function with signature 'vi' was exported, run
            // the callback with that signature.
            (function(a1) { throw 'Internal Error! Attempted to invoke wasm function pointer with signature "vi", but no such functions have gotten exported!'; })(callback.arg);
          }
        } else {
